...
class RequestField:
    ...
    type: str          # the field type — a row in the served registry, never a fixed list
...
| anything else, and a type the registry does not carry | `str` | The decrypted plaintext. |
